...
from scripts.measure_barnyard_economist import ROOT, validate


class BarnyardEconomistTest(unittest.TestCase):
    def test_provenance_portability_and_holdout_manifest(self):
        fixture = json.loads((ROOT / "tests/fixtures/barnyard_economist.json").read_text())
    ...
    def test_measurement_records_real_contract_and_divergence(self):
        report = json.loads((ROOT / "docs/measurements/SOT-2957/SOT-2958-barnyard-economist.json").read_text())
